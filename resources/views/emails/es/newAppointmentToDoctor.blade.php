                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
                        <tr>
                            <td align="center" bgcolor="#334155" style="padding: 40px 0 30px 0;color: #ffffff;font-size: 24px;font-weight: bold;font-family: Arial, sans-serif;border-top-left-radius: 10px;border-top-right-radius: 10px;">
                                ...
                                <h1 style="margin:0;font-size:42px;margin-top:10px;padding: 0px 20px;">¡Nueva cita</h1>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td style="color: #333333; font-family: Arial, sans-serif; font-size: 14px;">  
                                            <p>Hola, {{$doctorFullname}}</p>
                                            <br>
                                            <p>Queremos informar que el paciente {{$patientFullname}} ha generada exitosamente una cita. Aquí tienes los detalles:</p>
                                            <br>
                                            <p>Fecha: {{$appointment_date}}</p>
                                            <p>Lugar: {{$appointment_fullAddress}}</p>
                                            <p>Asunto: {{$subject}}</p>
                                            <br>
                                            <br>
                                            <p>Atentamente,</p>
