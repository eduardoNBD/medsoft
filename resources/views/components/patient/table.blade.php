<div class="bg_Secondary relative shadow-md rounded-lg">
    <div class="pt-4 px-4 table_text flex flex-col xs:flex-row justify-between gap-2">
        ...
        <div class="md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
            <a href="{{$_['baseURL'].$_['routes']['users']['new']}}?role=3" class=" flex items-center justify-center button_success focus:ring-4 font-medium rounded-lg text-sm px-4 py-2">
    ...
    <table class="w-full text-sm text-left">
        <thead class="text-xs uppercase table_header text_table_header">
            <tr>  
                ...
                <th scope="col" class="px-2 md:px-4 py-3 hidden md:table-cell">{{__("routes.medical")}}</th>  
                <th scope="col" class="px-2 md:px-4 py-3">{{__("messages.contact")}}</th>   
                <th scope="col" class="px-2 md:px-4 py-3 hidden md:table-cell">{{__("messages.address")}}</th>  
                <th scope="col" class="px-2 md:px-4 py-3 hidden md:table-cell">{{__("messages.dob")}}</th>  
