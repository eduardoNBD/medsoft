<form action="#" method="POST" id="form"  class="grid grid-cols-1 md:grid-cols-7 gap-y-4 gap-x-0 md:gap-4 mx-4"> 
    ...
    @endif 
    <section class="bg-white dark:bg-slate-900 px-3 md:px-7 pt-5 pb-5 w-full rounded-lg col-span-6 md:col-span-3 relative">
        <button type="button" id="delMain" class="bg-red-500 p-2 text-white rounded-full absolute right-[36%] top-[3%] {{$medicalUnit->logo ? "" : "hidden"}}" >
    ...
    <section class="bg-white dark:bg-slate-900 px-3 md:px-7 pt-5 pb-5 w-full rounded-lg col-span-6 md:col-span-4 h-fit">
        @csrf <!-- {{ csrf_field() }} --> 
        <h1 class="text-center text-2xl font-bold text-[#526270] mb-4">{{__($title)}}</h1>
        <hr>
        <div class="grid grid-cols-1 md:grid-cols-2 sm:mx-10 mt-4">  
            <div class="px-2 col-span-2 md:col-span-1">
                <div class="relative z-0 mb-2 group">
                    <input type="text" autocomplete="off" name="name" id="name" value="{{$medicalUnit->name}}" class="block py-2.5 px-0 w-full text-sm input_text bg-transparent border-0 border-b-2 input_border appearance-none focus:outline-none focus:ring-0 peer" placeholder="" />
            ...
            <div class="px-2 col-span-2 md:col-span-1">
                <div class="relative z-0 mb-2 group">
                    <input type="text" autocomplete="off" name="email" id="email" value="{{$medicalUnit->email}}" class="block py-2.5 px-0 w-full text-sm input_text bg-transparent border-0 border-b-2 input_border appearance-none focus:outline-none focus:ring-0 peer" placeholder="" />
            ...
            <div class="px-2 col-span-2 md:col-span-1">
                <div class="relative z-0 mb-2 group">
                    <input type="text" autocomplete="off" name="phone" id="phone" value="{{$medicalUnit->phone}}" class="block py-2.5 px-0 w-full text-sm input_text bg-transparent border-0 border-b-2 input_border appearance-none focus:outline-none focus:ring-0 peer" placeholder="" />
            ...
            <div class="px-2 col-span-2 md:col-span-1">
                <div class="relative z-0 mb md:mb-2 group">
                    <input type="text" name="address" id="address" value="{{$medicalUnit->address}}" class="block py-2 px-0 w-full text-sm input_text bg-transparent border-0 border-b-2 input_border appearance-none focus:outline-none focus:ring-0 peer" placeholder="" />
            ...
            <div class="px-2 col-span-2 md:col-span-1">
                <div class="relative z-0 mb md:mb-2 group">
                    <input type="text" name="city" id="city" value="{{$medicalUnit->city}}" class="block py-2 px-0 w-full text-sm input_text bg-transparent border-0 border-b-2 input_border appearance-none focus:outline-none focus:ring-0 peer" placeholder="" />
            ...
            <div class="px-2 col-span-2 md:col-span-1">
                <div class="relative z-0 mb md:mb-2 group">
                    <input type="text" name="state" id="state" value="{{$medicalUnit->state}}" class="block py-2 px-0 w-full text-sm input_text bg-transparent border-0 border-b-2 input_border appearance-none focus:outline-none focus:ring-0 peer" placeholder="" />
            ...
            <div class="px-2 col-span-2 md:col-span-1">
                <div class="relative z-0 mb md:mb-2 group">
                    <input type="text" name="zipcode" id="zipcode" value="{{$medicalUnit->zipcode}}" class="block py-2 px-0 w-full text-sm input_text bg-transparent border-0 border-b-2 input_border appearance-none focus:outline-none focus:ring-0 peer" placeholder="" />
            ...
            <div class="px-2 col-span-2 md:col-span-1">
                <div class="relative z-0 mb md:mb-2 group">
                    <select name="country" id="country" class="bg-white dark:bg-slate-900 block p-2 w-full text-sm input_text bg-transparent border-0 border-b-2 input_border appearance-none focus:outline-none focus:ring-0 peer">
