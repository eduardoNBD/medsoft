@extends('layouts.dashboard',[ 'current_route'  => '/dashboard/expenses'])

@section('title', __('routes.expenses')) 
            ...
            <div class="relative bg_modal rounded-lg shadow ">
                ...
                <div class="p-4 md:p-5 text-center">
                    <svg class="mx-auto mb-4 text-gray-400 w-12 h-12" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                     ...
                     <h3 class="mb-5 text-lg font-normal title_text">{{__("messages.expenseDeleteAsk")}}</h3>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg_modal rounded-lg shadow ">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <button  onclick="confirmRestore()" data-modal-hide="restoreModal" type="button" class="button_success focus:ring-4 focus:outline-none ont-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        {{__("messages.yes")}}
                    </button>
...
@section('scripts')
    <script> 
        const url = '{{$_['baseURL']."/expenses/list?page="}}'; 
        const urlDel = '{{$_['baseURL']."/expenses/delete/"}}';
        const urlRes = '{{$_['baseURL']."/expenses/restore/"}}'; 
        ...
        const withoutExpensesSearch = "{{__('messages.withoutExpenses')}}";
        const expenseEditURL = "{{$_['baseURL'].$_['routes']['expenses']['edit']('')}}";
        let currentPage = {{$page}}; 
        const msg = "{{isset($_GET['msg']) ? $_GET['msg'] : ""}}";
        const currentURL = "{{$_['baseURL'].$_['routes']['expenses']['root']}}/"; 
    ...
    <script src="{{ asset('/resources/js/pages/expenses.js') }}"></script> 
@stop