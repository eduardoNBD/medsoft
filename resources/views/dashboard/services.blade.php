...
@section('title', __('routes.services')) 
...
@section('breadcrumbs')
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li class="inline-flex items-center">
                <a href="{{$_['baseURL'].$_['routes']['services']['root']}}" class="inline-flex items-center text-sm font-medium breadcrumbs_text">
...
@section('content')
    <section class="mx-2 md:m-4">
        <div class="mx-auto px-2"> 
            @include('../components/service/table')
        </div>
    </section> 
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg_modal rounded-lg shadow">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal title_text">{{__("messages.serviceDeleteAsk")}}</h3>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg_modal rounded-lg shadow">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal title_text">{{__("messages.serviceRestoreAsk")}}</h3>
...
@section('scripts')
    <script> 
        const url = '{{$_['baseURL']."/services/list?page="}}'; 
        const urlDel = '{{$_['baseURL']."/services/delete/"}}';
        const urlRes = '{{$_['baseURL']."/services/restore/"}}';
        ...
        const withoutServicesSearch = "{{__('messages.withoutServices')}}";
        const serviceEditURL = "{{$_['baseURL'].$_['routes']['services']['edit']('')}}";
        let currentPage = {{$page}}; 
        const msg = "{{isset($_GET['msg']) ? $_GET['msg'] : ""}}";
        const currentURL = "{{$_['baseURL'].$_['routes']['services']['root']}}/"; 
    ...
    <script src="{{ asset('/resources/js/pages/services.js') }}"></script> 
@stop