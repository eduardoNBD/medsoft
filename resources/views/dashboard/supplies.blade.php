...
@section('title', __('routes.supplies')) 
...
@section('content')
    <section class="mx-2 md:m-4">
        <div class="mx-auto px-2"> 
            @include('../components/supply/table')
        </div>
    </section> 
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg_modal rounded-lg shadow">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal title_text">{{__("messages.supplyDeleteAsk")}}</h3>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg_modal rounded-lg shadow">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal title_text">{{__("messages.supplyRestoreAsk")}}</h3>
...
@section('scripts')
    <script> 
        const url = '{{$_['baseURL']."/supplies/list?page="}}'; 
        const urlDel = '{{$_['baseURL']."/supplies/delete/"}}';
        const urlRes = '{{$_['baseURL']."/supplies/restore/"}}';
        ...
        const costText = "{{__('messages.cost')}}";
        const deletedText = "{{__('messages.deleted_his')}}";
        const quantityText = "{{__('messages.qty')}}";
        const withoutSuppliesSearch = "{{__('messages.withoutSupplies')}}";
        const supplyEditURL = "{{$_['baseURL'].$_['routes']['supplies']['edit']('')}}";
        const supplyDetailURL = "{{$_['baseURL'].$_['routes']['supplies']['detail']('')}}";
        let currentPage = {{$page}}; 
        const msg = "{{isset($_GET['msg']) ? $_GET['msg'] : ""}}";
        const currentURL = "{{$_['baseURL'].$_['routes']['supplies']['root']}}/"; 
    ...
    <script src="{{ asset('/resources/js/pages/supplies.js') }}"></script> 
@stop